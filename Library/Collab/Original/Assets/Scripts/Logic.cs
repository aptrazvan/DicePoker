        ...
        if (begin)
        {
            ...
            for (i = 0; i < 5; i++)
            {
                ...
                if (diceValues[zar[i]] == 0 && zar[i]>=2&&zar[i]<=6) sixx++;
                    diceValues[zar[i]]++;
                if (diceValues[zar[i]] == 5) points[0] = true;
                if (diceValues[zar[i]] == 4) points[1] = true;
                if (diceValues[zar[i]] == 3) threes++;
                if (diceValues[zar[i]] == 2) twos++; 
